...
public abstract class BaseCacheManagerProducer {
	...
	private void configureProtoMarshaller(SerializationContext serCtx, RemoteCacheManager remoteCacheManager) {
		...
		try {
			...
			resisterMessageMarshaller( serCtx );
	...
	protected abstract void resisterMessageMarshaller(SerializationContext serCtx);
